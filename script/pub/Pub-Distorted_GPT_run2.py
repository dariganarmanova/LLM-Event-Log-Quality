...
# Generated on: 2025-11-14T13:21:30.562299
...
for activity1, activity2 in combinations(unique_activities, 2):
...
for cluster in clusters.values():
    if len(cluster) > 1:
        ...
        most_common = Counter(original_forms).most_common(1)[0][0]
...
print(f"Total clean activities: {total_clean}")
