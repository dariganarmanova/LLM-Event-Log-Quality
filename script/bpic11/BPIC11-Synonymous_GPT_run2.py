...
# Generated on: 2025-11-13T11:51:53.708128
...
print(f"Run 2: Synonymous events replaced: {df['Activity'].nunique() - len(unique_activities)}")
print(f"Run 2: Unique activities before: {len(unique_activities)} → after: {df['Activity'].nunique()}")