...
# Generated on: 2025-11-13T16:14:39.212747
...
print(f"Run 2: Total number of events before merging: {total_events_before}")
print(f"Run 2: Total number of events after merging: {total_events_after}")
print(f"Run 2: Number of unique activities before merging: {unique_activities_before}")
print(f"Run 2: Number of unique activities after merging: {unique_activities_after}")
print(f"Run 2: Total reduction percentage: {reduction_percentage:.2f}%")

# Print sample of merged activities
merged_samples = final_df[final_df[activity_column].str.contains(';')][activity_column].head(10)
if not merged_samples.empty:
    print("Sample of merged activities:")
    for activity in merged_samples:
        print(activity)
