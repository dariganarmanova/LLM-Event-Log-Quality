...
# Generated on: 2025-11-13T16:20:24.618997
...
for cluster_id in df['ClusterID'].unique():
    ...
    canonical_map[cluster_id] = canonical_name

df['Activity_fixed'] = df.apply(
    lambda row: canonical_map[row['ClusterID']] if row['ishomonymous'] else row['BaseActivity'], axis=1
)
