#!/usr/bin/env python3
"""
Parameterized Llama CSV Processor with Clean Logging
Usage: python llama_processor.py <csv_file> <prompt_file> [options]
"""
import os
import subprocess
import pandas as pd
...
class ParameterizedLlamaProcessor:
    def __init__(self, api_key=None, model_name="meta-llama/Llama-3.1-8B-Instruct"):
        """Initialize the Parameterized Llama CSV Processor"""
...
"""
    ...
    def save_generated_script(self, code, csv_path, prompt_path, run_number):
        ...
        script_filename = f"{csv_basename}_Llama_run{run_number}.py"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Parameterized Llama CSV Processor")
    ...
    print("[INFO] Starting Parameterized Llama CSV Processing Pipeline")
...
if __name__ == "__main__":
    if len(os.sys.argv) == 1:
        print("[INFO] Parameterized Llama CSV Processor")
        print("[INFO] Usage: python llama_processor.py <csv_file> <prompt_file> [options]")
    else:
        main()